<template>
  <PageComponent title="Dashboard">
    ...
    <div
      v-else
      class="gap-5 text-gray-700 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3"
    >
      <!--      Total Survey-->
      <div
        class="animate-fade-in-down lg:order-2  order-1"
        style="animation-delay:.1s"
      >
        <h3 class="text-lg w-fit font-semibold mb-3">
          Total Surveys
        </h3>
      ...
      <!--      Total Answers-->
      <div
        class="animate-fade-in-down  lg:order-4  order-2"
      ...
      <!--      Latest Survey-->
      <div
        class="animate-fade-in-down lg:order-1 order-3 row-span-2"
      ...
      >
        ...
        >
          <div class="absolute w-full flex justify-between">
            ...
            <span
              :class="data.latestSurvey.status ? 'bg-green-500' : 'bg-yellow-600'"
          ...
          <div
            v-else
            class="h-60 flex justify-center items-center text-slate-300"
          >
            <svg
              class="w-10 h-10"
              fill="none"
          ...
          <div class="bg-white rounded-t-2xl -mt-5 relative px-5 py-5">
            ...
            <div class="flex justify-between mt-6">
              ...
              <button
                class="flex py-2 px-4 border bg-indigo-50 font-semibold border-transparent text-sm rounded-md text-indigo-500
                        hover:bg-indigo-700 hover:text-white transition-colors focus:ring-2
                        focus:ring-offset-2 focus:ring-indigo-500"
              >
                Show Answers
      ...
      <!--      Latest Answers-->
      <div
        class="animate-fade-in-down lg:order-3 order-4 row-span-2"
      ...
      >
        ...
        <div v-if="data.latestAnswers">
          <a
            v-for="(answer, index) of data.latestAnswers"
            :key="answer.id"
